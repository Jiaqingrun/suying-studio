...
def rewrite_narration_with_ollama(
    *,
    ...
    tone_guidance = {
        ...
        "professional": "专业克制说明，只讲已确认货名与用途，禁止念画面里看不清的东西",
    ...
    voice_universal = (
        ...
        "② **识别不出就不要说**：看不清具体货名/SKU时，禁止用「黑色物体/黄色物品/"
        "能看到/可见××/手持××/背景货架/上方货架上有/袋装物品/立柱横梁/"
        "印有汉字/包装物/桶状物体/堆叠整齐/侧面有/金属框架/黑色图案/"
        "物体表面/特写显示/圆柱体质感/反光带/穿短袖站位/手扶货物堆/"
        "穿黑衣男子站在画面左侧」等"
        "含糊盘点硬凑字幕；宁可少说一句，也不要猜着介绍。"
        "③ 禁止问卷纸质腔「进一步确认需求」；"
    ...
    if product_display:
        scene_rule = (
            voice_universal
            + "【模式=商品仓配介绍】写短句人话：只点名底稿/事实里**已确认**的货名品类"
            "（扳手、卷尺、板材、料斗等）；看不清的颜色块、货架结构、印刷字一律跳过。"
            ...
            "禁止「最上方/依次变小/手柄上有刻字/身穿/堆放着/可见立柱/背景货架/"
            "结构清晰/印有汉字」类构图念白。"
